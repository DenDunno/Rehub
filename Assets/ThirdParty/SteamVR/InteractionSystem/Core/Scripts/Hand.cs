...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        [SerializeField] private bool _drawModel = true;
        [SerializeField] private bool _enableOnStart = false;
        public Hand otherHand;
        public VRHand VrHand { get; private set; }
        ...
        private void InitController()
        {
            ...
            VrHand = renderModelInstance.GetComponentInChildren<VRHand>();
            renderModels.Add(mainRenderModel);
            mainRenderModel.GetComponentInChildren<Renderer>().enabled = _drawModel;
