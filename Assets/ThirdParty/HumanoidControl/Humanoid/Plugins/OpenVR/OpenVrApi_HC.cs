...
namespace Passer {
    ...
    public class CVRSystem {
        OpenVRSystem FnTable;
        internal CVRSystem(IntPtr pInterface) {
            FnTable = (OpenVRSystem)Marshal.PtrToStructure(pInterface, typeof(OpenVRSystem));
        }
        ...
        struct PollNextEventUnion {
            [FieldOffset(0)]
            public OpenVRSystem._PollNextEvent pPollNextEvent;
            [FieldOffset(0)]
        ...
        struct GetControllerStateUnion {
            [FieldOffset(0)]
            public OpenVRSystem._GetControllerState pGetControllerState;
            [FieldOffset(0)]
        ...
        struct GetControllerStateWithPoseUnion {
            [FieldOffset(0)]
            public OpenVRSystem._GetControllerStateWithPose pGetControllerStateWithPose;
            [FieldOffset(0)]
