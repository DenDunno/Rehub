...
namespace Passer.Humanoid {
    ...
    [System.Serializable]
    public class ViveTrackerTorso : TorsoSensor {
...
#if pUNITYXR
            tracker = hipsTarget.humanoid.unityXR;
#else
        ...
        public void ResetSensor() {
            ...
            if (viveTracker != null) {
                List<ViveTrackerComponent> viveTrackers = hipsTarget.humanoid.openVR.viveTrackers;
                viveTrackers.Add(ViveTracker.NewViveTracker(hipsTarget.humanoid.openVR.tracker, (uint)viveTracker.trackerId));
