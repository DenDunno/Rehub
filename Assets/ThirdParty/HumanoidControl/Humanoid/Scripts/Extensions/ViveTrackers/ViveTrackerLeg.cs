...
namespace Passer.Humanoid {
    ...
    [System.Serializable]
    public class ViveTrackerLeg : LegSensor {
        ...
        private static readonly Vector3 defaultLeftTrackerPosition = new(0, 0, 0.13F);
        private static readonly Quaternion defaultLeftTrackerRotation = Quaternion.identity;
        private static readonly Vector3 defaultRightTrackerPosition = new(0, 0, 0.13F);
...
#if pUNITYXR
            tracker = footTarget.humanoid.unityXR;
#else
        ...
        public int FindFootTracker(bool isLeft) {
            ...
            if (foundTracker != null && footTarget.otherFoot.viveTracker.viveTracker == foundTracker) {
        ...
        public void ResetSensor() {
            ...
            if (viveTracker != null) {
                List<ViveTrackerComponent> viveTrackers = footTarget.humanoid.openVR.viveTrackers;
                viveTrackers.Add(ViveTracker.NewViveTracker(footTarget.humanoid.openVR.tracker, (uint)viveTracker.trackerId));
