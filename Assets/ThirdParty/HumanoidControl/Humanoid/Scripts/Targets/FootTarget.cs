...
namespace Passer.Humanoid {
    ...
    /// </summary>
    /// More information on the Humanoid Control Foot Target Component click
    /// <a href="https://passervr.com/documentation/humanoid-control/foot-target/">here</a>
    ...
    public class FootTarget : HumanoidTarget {
            ...
            public override void RetrieveBones(HumanoidControl humanoid) {
                ...
                if (humanoid.avatarRig != null) {
                    if (footTarget.isLeft)
                        GetDefaultBone(humanoid.avatarRig, ref bone.transform, boneId, "LeftUpLeg");
                    else
                        GetDefaultBone(humanoid.avatarRig, ref bone.transform, boneId, "RightUpLeg");
                }
            }
        ...
        public class TargetedLowerLegBone : TargetedBone {
            ...
            public override void RetrieveBones(HumanoidControl humanoid) {
                ...
                if (humanoid.avatarRig != null) {
                    if (footTarget.isLeft)
                        GetDefaultBone(humanoid.avatarRig, ref bone.transform, boneId, "LeftLeg");
                    else
                        GetDefaultBone(humanoid.avatarRig, ref bone.transform, boneId, "RightLeg");
                }
            }
        ...
        public class TargetedFootBone : TargetedBone {
            ...
            public override void RetrieveBones(HumanoidControl humanoid) {
                ...
                if (humanoid.avatarRig != null) {
                    if (footTarget.isLeft)
                        GetDefaultBone(humanoid.avatarRig, ref bone.transform, boneId, "LeftFoot");
                    else
                        GetDefaultBone(humanoid.avatarRig, ref bone.transform, boneId, "RightFoot");
                }
            }
        ...
        public class TargetedToesBone : TargetedBone {
            ...
            public override void RetrieveBones(HumanoidControl humanoid) {
                ...
                if (humanoid.avatarRig != null) {
                    if (footTarget.isLeft)
                        GetDefaultBone(humanoid.avatarRig, ref bone.transform, boneId, "LeftToeBase");
                    else
                        GetDefaultBone(humanoid.avatarRig, ref bone.transform, boneId, "RightToeBase");
                }
            }
