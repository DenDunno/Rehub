...
namespace Passer {
    ...
    public class ControllerInput : MonoBehaviour {
        ...
        public ControllerEventHandlers[] leftInputEvents = new ControllerEventHandlers[] {
            new() { label = "Left Vertical", id = 0, defaultParameterProperty = "leftStickVertical" },
            new() { label = "Left Horizontal", id = 1, defaultParameterProperty = "leftStickHorizontal" },
            new() { label = "Left Stick Button", id = 2, eventTypeLabels = eventTypeLabels },
            new() { label = "Left Touchpad Vertical", id = 3, defaultParameterProperty = "leftTouchpadVertical" },
            new() { label = "Left Touchpad Horizontal", id = 4, defaultParameterProperty = "leftTouchpadHorizontal" },
            new() { label = "Left Touchpad Button", id = 5, eventTypeLabels = eventTypeLabels },
            new() { label = "Left Button 1", id = 6, eventTypeLabels = eventTypeLabels },
            new() { label = "Left Button 2", id = 7, eventTypeLabels = eventTypeLabels },
            new() { label = "Left Button 3", id = 8, eventTypeLabels = eventTypeLabels },
            new() { label = "Left Button 4", id = 9, eventTypeLabels = eventTypeLabels },
            new() { label = "Left Trigger 1", id = 10, eventTypeLabels = eventTypeLabels },
            new() { label = "Left Trigger 2", id = 11, eventTypeLabels = eventTypeLabels },
            new() { label = "Left Option", id = 12, eventTypeLabels = eventTypeLabels },
        };
        public ControllerEventHandlers[] rightInputEvents = new ControllerEventHandlers[] {
            new() { label = "Right Vertical", id = 0, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Horizontal", id = 1, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Stick Button", id = 2, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Touchpad Vertical", id = 3, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Touchpad Horizontal", id = 4, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Touchpad Button", id = 5, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Button 1", id = 6, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Button 2", id = 7, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Button 3", id = 8, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Button 4", id = 9, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Trigger 1", id = 10, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Trigger 2", id = 11, eventTypeLabels = eventTypeLabels },
            new() { label = "Right Option", id = 12, eventTypeLabels = eventTypeLabels },
        };
