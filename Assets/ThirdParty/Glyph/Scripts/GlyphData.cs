...
//         if (_glyphData.points.Length > 1)
//         {
//             for (int n = 0; n < _glyphData.points.Length - 1; n++)
//             {
//                 Vector2 gP1 = _glyphData.points[n] * (tex.width/2) + pointOffset;
//                 Vector2 gP2 = _glyphData.points[n + 1] * (tex.height/2) + pointOffset;
//
...
//     {
//         Vector2 minPoint = _glyphData.points[0];
//         Vector2 maxPoint = _glyphData.points[0];
//
//         foreach (Vector2 p in _glyphData.points)
//         {
